...
myApp.controller("PackCtrl", ['$http', '$scope', '$location', '$window','$cookies', function($http, $scope, $location, $window, $cookies) {
	...
	if(typeof(channel) != "undefined"){
		 ...
		 .success(function(result)
		{
			pp.CLIENT_ID = result;
			initChatRoom();
			//drone.channelId= pp.CLIENT_ID;
			//drone.open(pp.CLIENT_ID);
		})
	...
	//pp.roomIndex = 0;
	//pp.roomIDs = ['cXdiFTzPpMnd5mpl','0Uzkq9Cb7JvkeaP6', 'wCfKJzIJcslTQIlI', 'K4mUtHjgcHzUXJua', 'D7hof1MPvm9RcPtH','apJxrH05M3geivLs', 'McUJrFPAujjT8ZlB', 'gC5uKleIvLgyjkbQ','D2qkdGOq5rajFMFV', 'CUoqHu1ky08c461L'];
